...
The design system this app is built on: tokens, components and the rules that hold them together. It is my own
system, in the flat, anti-corporate lineage of creator tools like Gumroad and Buy Me a Coffee (see Influences);
every value below belongs to this system. It is not Ottodot's brand guideline.
...
**Role:** Text input — also the shape of every select trigger
...
**Role:** Inline chip for one small fact next to a title: a count, a subject, a status
...
Flat hot-pink #ff90e8 ellipse with a 1px #000000 stroke, 45° tilt, centered brand initial ('O') set in ABC Favorit 700. Used at 60–160px sizes; always floating, never as a clickable element.
...
Where the look comes from, so the lineage is on the record:

- **Gumroad** — the closest relative: cream canvas, one hot-pink motif, black filled buttons, hairline-bordered cards.
- **Buy Me a Coffee** — warm cream background, flat illustration mascots, informal tone, high-contrast black CTA.
- **Substack** — off-white canvas and oversized single-family geometric sans for headlines.
- **Carrd** — single-typeface system, tight negative tracking on display, ultra-flat surfaces with hairline borders.
...
:root {
  ...
  --font-abc-favorit:
    "ABC Favorit", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
