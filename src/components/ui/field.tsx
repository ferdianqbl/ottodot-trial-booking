...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-3 font-medium data-[variant=label]:text-body-sm data-[variant=legend]:text-body",
        className
      )}
      {...props}
    />
...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:cursor-pointer has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border has-[>[data-slot=field]]:bg-card has-[>[data-slot=field]]:not-has-[:disabled,[data-disabled]]:hover:border-foreground has-data-checked:border-foreground has-[>[data-slot=field]]:has-[:focus-visible]:outline-2 has-[>[data-slot=field]]:has-[:focus-visible]:outline-offset-2 has-[>[data-slot=field]]:has-[:focus-visible]:outline-ring *:data-[slot=field]:px-4 *:data-[slot=field]:py-3",
